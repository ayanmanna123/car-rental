  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-orange-500/10 dark:bg-orange-500/20 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-9 bg-orange-500 rounded-lg relative shadow-xl"
          >
            {/* Windows */}
            <div className="absolute top-0 left-4 w-10 h-4 bg-orange-600 dark:bg-orange-700/50 rounded-t-lg"></div>
            <div className="absolute -top-1 right-3 w-7 h-4 bg-orange-600 dark:bg-orange-700/50 rounded-t-lg skew-x-12"></div>
